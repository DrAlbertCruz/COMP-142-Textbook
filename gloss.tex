...
\newglossaryentry{base-8}{name={base-8},%
    description={Base-8 numbering system also known as octets}
}
\newglossaryentry{base-16}{name={base-16},%
    description={Base-16 numbering system also known as hexadecimal}
}
\newglossaryentry{bit}{name={bit},description={A single base-2 digit}}
\newglossaryentry{address}{name={address},description={The location of a chunk of data in memory}}
\newglossaryentry{nibble}{name={nibble},description={Four bits}}
\newglossaryentry{ones compliment}{name={ones' compliment},description={A system for representing negative numbers using negation}}
\newglossaryentry{aryabhata}{name={Aryabhata of Kusumapura},description={Developed place value notation for base-10}}
\newglossaryentry{brahmagupta}{name={Brahmagupta},description={Invented the zero symbol for base-10}}
\newglossaryentry{abulhasan}{name={Abu'l-Hasan al-Uqlidisi},description={Among the first to use a fractional notation for base-10}}
\newglossaryentry{sindibnali}{name={Sind ibn Ali},description={Among the first to use a decimal point in base-10}}
\newglossaryentry{tally marks}{name={tally marks},description={A base-1 counting system}}
\newglossaryentry{iching}{name={\textit{I Ching}},description={An ancient Chinese text that inspired Western mathematicians to study base-2}}
\newglossaryentry{divide-by-2}{name={Divide-by-2},description={An algorithm for converting a decimal number to a binary number}}